...
function AboutUs() {
  return (
    <Element name="about">
      <motion.section
        {...fadeUpSection()}
        className="w-full py-16 px-4 mob:px-6 tab:px-12 lap:px-20 desk:px-32 "
      >
        <div className="max-w-7xl mx-auto flex flex-col-reverse mob:flex-col   items-center gap-8 lap:flex-row-reverse">
          ...
          <div className="flex-1 flex  flex-col justify-center items-start gap-4">
            ...
            <P otherStyle={"lap:text-left  lap:mx-0"}>
              ...
              client stress of catering for their guests both indoor and
              outdoor. Ensuring building a loyal customer base, and maintaining
              consistent product quality and delivery also both in decoration,
