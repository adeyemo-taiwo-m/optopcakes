...
function CartButton() {
  ...
  return (
    ...
    >
      ...
      {cart.length ? (
        <div className="text-white bg-primary-default hover:bg-primary-hover border-2 border-primary-light  flex justify-center items-center rounded-full w-8 h-8 absolute right-0 top-0 transform translate-x-2 -translate-y-2">
          {cart?.length}
        </div>
      ) : null}
    </motion.div>
